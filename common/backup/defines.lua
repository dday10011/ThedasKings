...
NCharacter = {
	...
	NOT_SPOUSE_FERTILITY_MULT = 0.50,				-- Applied to fertility when the two characters are not married
...
NTechnology = {
	DONT_EXECUTE_TECH_BEFORE = 8929,				-- Set this to your earliest starting year
